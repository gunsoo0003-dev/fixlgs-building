      ...
      <path className="ecg-light" d="M0 32 H82 L96 32 L106 12 L119 52 L132 20 L144 32 H260"/>
        ...
        <section className="services-section" aria-label={copy.servicesAria}>
          <div className="services-grid">
            {services.map((s) => (
              <a className="service-card" id={s.id} href={s.id === 'self' ? `${BASE_PATH}/${locale}/self-check` : s.id === 'analysis' ? `${BASE_PATH}/${locale}/analysis` : s.id === 'contract' ? `${BASE_PATH}/${locale}/contract` : '#'} key={s.id}>
